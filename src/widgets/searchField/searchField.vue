<template>
  <div class="search__field">
    <input
      ...
      @input="
        $emit('update:customValue', ($event.target as HTMLInputElement).value),
          $emit('changingQuery', ($event.target as HTMLInputElement).value)
      "
      placeholder="Поиск начинается здесь..."
    />
  </div>
</template>
